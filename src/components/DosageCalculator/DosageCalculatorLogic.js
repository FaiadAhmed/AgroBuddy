...
//   totalMg  — total milligrams needed
//   totalMl  — volume in millilitres to administer
//   warning  — a string warning message, or null if none
//
...
export function calculateDosage(weightKg, dosePerKg, concentration) {
  ...
  return {
    totalMg: parseFloat(totalMg.toFixed(4)),  // Round to avoid floating-point noise
