...
export default function AnimalProfiles() {
  ...
  async function handleAddAnimal(e) {
    ...
    try {
      ...
      setFormData({ name: '', species: '', age: '', weight: '', notes: '' });
  ...
  async function handleDelete(id) {
    ...
    if (!window.confirm('Delete this animal profile?')) return;
    ...
    <div className="animal-profiles">
      ...
      <div className="ap-header">
        ...
        <button
          ...
          onClick={() => setShowForm((prev) => !prev)}  // flip boolean
        >
          {/* Button label changes depending on whether the form is open */}
        ...
        {animals.map((animal) => (
          ...
          <div key={animal.id} className="ap-card card">
            ...
            <ul className="ap-details">
              ...
              {animal.age    && <li>Age: <strong>{animal.age} yr</strong></li>}
              {animal.weight && <li>Weight: <strong>{animal.weight} kg</strong></li>}
